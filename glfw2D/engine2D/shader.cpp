...
Shader::Shader(const std::string& fileName)
{
	...
	m_uniforms[1] = glGetUniformLocation(m_program, "ambient");
	m_uniforms[2] = glGetUniformLocation(m_program, "objects");
	m_uniforms[3] = glGetUniformLocation(m_program, "objColors");
